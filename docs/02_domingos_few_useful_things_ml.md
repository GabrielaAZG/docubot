Título: A Few Useful Things to Know About Machine Learning
Autor: Pedro Domingos
Fuente: https://homes.cs.washington.edu/~pedrod/papers/cacm12.pdf
Acceso: Preprint libre del autor (CACM 2012)
...
tion between feature x j and the class y. 
MakeNode(x ,c0,c1) returns a node that 
tests feature x and has c 0 as the child 
...
it’ s Generalization that c ounts
...
table 1. t he three components of learning algorithms.
Representation evaluation o ptimization
Instances Accuracy/
e
rror rate c
ombinatorial optimization
 K-nearest neighbor Precision and recall Greedy search
 Support vector machines Squared error 
b
eam search
Hyperplanes l
ikelihood 
...
aive 
b
ayes Posterior probability c
ontinuous optimization
 
logistic regression Information gain Unconstr
ained
Decision trees K-
l
 divergence Gradient descent
Sets of rules c
ost/Utility 
c
onjugate gradient
 Propositional rules Margin Quasi-
n
ewton methods
...
TS0 ← e xamples in TrainSet with x* = 0
TS1 ← e xamples in TrainSet with x* = 1
return Make
n
ode(x*, learnDt (TS0), learnDt (TS1))
...
are 2
100 − 10 6 examples whose classes 
...
alization error into bias and variance.
9 
...
82 CommuniCA tionS oF thE ACm | oCT obeR 2012 | V oL. 55 | no. 10
review articles
...
simple.
5 Let’s say a classifier is bad 
...
2
e possible different functions, so 
since there are 2 d possible examples, 
the total number of functions is 2 2d
. 
...
86 CommuniCA tionS oF thE ACm | oCT obeR 2012 | V oL. 55 | no. 10
review articles
...
Happy learning! 
References
1. bauer, e. and k ohavi, r. an empirical comparison of 
...
(edmonton, Canada, 2002). a CM Press, ny, 525–531.
12. kibler, d . and langley, P. Machine learning as an 
experimental science. In Proceedings of the 3 rd 
European Working Session on Learning (l ondon, uk, 
1988). Pitman.
13. klockars, a.J. and sax, g . Multiple Comparisons. 
sage, beverly hills, Ca, 1986.
14. k ohavi, r., l ongbotham, r., sommerfield, d . and 
...
22. t enenbaum, J., silva, V. and l angford, J. a global 
...
of n bits in this way requires 2
n basis 
...
search frontiers in machine learning.
2
